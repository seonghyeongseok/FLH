    ...
    public function up()
    {
        ...
        */
        ...
        Schema::create('files', function (Blueprint $table) {
            ...
            $table->dateTime('fi_deadline');
            $table->integer('fi_registered_no')->unsigned();
            $table->integer('fi_route_id')->unsigned();
            $table->string('fi_name', 45);
            $table->timestamp('fi_registered_date')->nullable();
            $table->timestamp('fi_updated_date')->nullable();
